...
@Component({
  selector: 'app-add-tag-management',
  templateUrl: './add-tag-management.component.html',
  styleUrls: ['./add-tag-management.component.scss'],
...
export class AddTagManagementComponent implements OnInit {
